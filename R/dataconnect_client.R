...
#'   }
#'   \item{\code{fetch_data(study_environment_uuid, dataset_uuid)}}{
#'     Retrieve data from a single dataset.
#'     \itemize{
#'       \item \code{study_environment_uuid}: UUID of the target study environment (optional)
#'       \item \code{dataset_uuid}: UUID of the target dataset (required)
#'     }
...
#' data <- client$fetch_data(env_uuid, dataset_uuid)
#' 
