...
```{r}
# Consider choosing the first few rows of a dataset by using %>% head() if the dataset is extremely large 
...
Set up your project token where the resulting dataset (i.e., publishDF) will be pushed to. Please make sure it is published to the correct study environment and project. It is recommended to use dry_publish function to validate the result first before publish the resulting dataset back to Medidata Data Connect.
