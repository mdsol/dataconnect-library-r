...
This directory contains documentation snapshots for each release of the `dataconnect` R library.

## Available Versions

| Version | Documentation | Current version |
|---------|---------------|-----------------|
|1.2.0   | [README-v1.3.0\[WIP\].md](readme/README-v1.3.0[WIP].md) | No              |
|1.2.0   | [README-v1.2.0.md](readme/README-v1.2.0.md) | Yes              |
|1.1.0   | [README-v1.1.0.md](readme/README-v1.1.0.md) | No             |
